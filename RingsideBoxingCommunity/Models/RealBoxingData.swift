...
struct RealBoxingData {
    ...
    static let shakurStevenson = Fighter(id: "r_shakur", name: "Shakur Stevenson", nickname: "Fearless", record: "22-0-0", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Jesus_vs_Stevenson_2016_Rio_8cr.jpg/400px-Jesus_vs_Stevenson_2016_Rio_8cr.jpg")
    static let teofimoLopez = Fighter(id: "r_teofimo", name: "Teofimo Lopez", nickname: "The Takeover", record: "20-2-0", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Teofimo_Lopez.jpg/400px-Teofimo_Lopez.jpg")
    static let ryanGarcia = Fighter(id: "r_ryangarcia", name: "Ryan Garcia", nickname: "KingRy", record: "26-1-0", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/RYAN_GARCIA.jpg/400px-RYAN_GARCIA.jpg")
    ...
    static let keithThurman = Fighter(id: "r_thurman", name: "Keith Thurman", nickname: "One Time", record: "30-2-1", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Thurman_Bundu.jpg/400px-Thurman_Bundu.jpg")
    ...
    static let derekChisora = Fighter(id: "r_chisora", name: "Derek Chisora", nickname: "Del Boy", record: "35-13-0", country: "🇬🇧", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Dereck_Chisora.JPG/400px-Dereck_Chisora.JPG")
    static let deontayWilder = Fighter(id: "r_wilder", name: "Deontay Wilder", nickname: "The Bronze Bomber", record: "43-4-1", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Deontay_Wilder_2018_%28cropped%29.jpg/400px-Deontay_Wilder_2018_%28cropped%29.jpg")
    static let mosesItauma = Fighter(id: "r_itauma", name: "Moses Itauma", nickname: "", record: "12-0-0", country: "🇬🇧", imageURL: nil)
    static let jermaineFranklin = Fighter(id: "r_franklin", name: "Jermaine Franklin", nickname: "", record: "22-2-0", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Jermaine_Franklin.jpg/400px-Jermaine_Franklin.jpg")
    ...
    static let ricoVerhoeven = Fighter(id: "r_verhoeven", name: "Rico Verhoeven", nickname: "The King of Kickboxing", record: "1-0-0", country: "🇳🇱", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Rico-training.png/400px-Rico-training.png")
    ...
    static let floydMayweather = Fighter(id: "r_mayweather", name: "Floyd Mayweather", nickname: "Money", record: "50-0-0", country: "🇺🇸", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Floyd_Mayweather_Jr_2011.jpg/400px-Floyd_Mayweather_Jr_2011.jpg")
    static let mannyPacquiao = Fighter(id: "r_pacquiao", name: "Manny Pacquiao", nickname: "PacMan", record: "62-8-2", country: "🇵🇭", imageURL: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Pacquiao_and_Didal_%28cropped%29.jpg/400px-Pacquiao_and_Didal_%28cropped%29.jpg")
